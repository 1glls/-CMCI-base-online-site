...
import { Calendar, MessageSquare, Image, Share2, Settings, LogOut, Home, MapPin, Mail, Church, ClipboardList, DatabaseBackup, Languages } from "lucide-react"
...
export default function AdminDashboard() {
  ...
  const menuItems = [
    ...
    {
      title: "Traductions",
      description: "Traduction automatique du contenu",
      icon: Languages,
